...
export default async function handler(req, res) {
  ...
  try {
    const { description = '', location = '', duration = '', imageBase64 = null, imageType = null, jobType = 'service' } = req.body || {};
